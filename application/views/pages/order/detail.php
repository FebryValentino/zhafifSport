			...
			<div class="card">
				...
				<div class="col-lg-12">
					<div style="margin-top: 20px;">
						<h3 class="text-center"><strong>Order Detail #<?= $order['invoice'] ?></strong></h3>
						<a href="<?= base_url('order/invoice/' . $order['id']); ?>" class="btn btn-primary mb-3 float-right"><i class="fas fa-print"></i> Print</a>
					</div>
					<div class="card-body">
						<ul>
